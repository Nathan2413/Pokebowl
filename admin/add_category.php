					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Ajouter une catégorie de restaurant</h4>
                            </div>
                                <form action='' method='post' >
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="add_category.php" class="btn btn-inverse">Annuler</a>
                                    </div>
                                </form>
                            </div>
                        </div>
					   ...
					   <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Catégories listées</h4>
                                    ...
                                    <table id="myTable" class="table table-bordered table-hover table-striped">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th><center>Nom de catégorie</center></th>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td><center>'.$rows['c_id'].'</center></td>
																								<td><center>'.$rows['c_name'].'</center></td>
																								<td><center>'.$rows['date'].'</center></td>
																								
																									 <td><center><a href="delete_category.php?cat_del='.$rows['c_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
