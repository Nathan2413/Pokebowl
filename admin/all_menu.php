                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Tous les menus</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead class="thead-dark">
                                            <tr>
											 <th><center>Restaurants</center></th>
                                             <th><center>Plats</center></th>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td><center>'.$fetch['title'].'</center></td>
																					
																								<td><center>'.$rows['title'].'</center></td>
																								<td><center>'.$rows['slogan'].'</center></td>
																								<td><center>Rs '.$rows['price'].'</center></td>
																								
																								
																								<td><center><div class="col-md-3 col-lg-8 m-b-10">
																								<center><img src="Res_img/dishes/'.$rows['img'].'" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																								</div></center></td>
																								
																							
																									 <td><center><a href="delete_menu.php?menu_del='.$rows['d_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_menu.php?menu_upd='.$rows['d_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a></center></td></tr>';
