...
<head>
    ...
    <title>Tous les commandes</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Tous les commandes</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th><center>Titres</center></th>
                                                <th><center>Quantités</center></th>
                                                <th><center>Prix</center></th>
												<th><center>Addresse</center><center></center></th>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				<?php
																					echo ' <tr>
																					           <td><center>'.$rows['username'].'</center></td>
																								<td><center>'.$rows['title'].'</center></td>
																								<td><center>'.$rows['quantity'].'</center></td>
																								<td><center>Rs '.$rows['price'].'</center></td>
																								<td><center>'.$rows['address'].'</center></td>';
																								?>
																								<?php 
																			$status=$rows['status'];
																			...
																			{
																			?>
																			<td><center><button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Expédition</button></center> </td>
																		   <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
																			<td><center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span> En chemin!</button></center> </td> 
																			<?php
																				}
																			if($status=="closed")
																				{
																			?>
																			<td><center><button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Délivré</button> </center> </td> 
																			<?php 
																			} 
																			?>
																			<?php
																			if($status=="rejected")
																				{
																			?>
																			<td><center><button type="button" class="btn btn-danger"> <i class="fa fa-close"></i> Annulé</button></center> </td> 
																			<?php 
																			} 
																			?>
																						<?php																									
																				         ...
																				         ?>
																									 <td>
																									 <a href="delete_orders.php?order_del=<?php echo $rows['o_id'];?>" onclick="return confirm('Etes-vous sûr de supprimer cette commandes?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																								<?php
