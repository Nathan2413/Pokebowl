                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Tous les restaurants</h4>
                            </div>
                                    ...
                                    <thead class="thead-dark">
                                            <tr>
											 <th>Catégorie</th>
												...
												<th><center>Jours ouverts</center></th>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$mql="SELECT * FROM res_category where c_id='".$rows['c_id']."'";
																					...
																					echo ' <tr><td><center>'.$row['c_name'].'</center></td>
																								<td><center>'.$rows['title'].'</center></td>
																								<td><center>'.$rows['email'].'</center></td>
																								<td><center>'.$rows['phone'].'</center></td>
																								<td><center>'.$rows['url'].'</center></td>
																								
																								
																								<td><center>'.$rows['o_hr'].'</center></td>
																								<td><center>'.$rows['c_hr'].'</center></td>
																								<td><center>'.$rows['o_days'].'</center></td>
																								...
																								<td><center>'.$rows['date'].'</center></td>
																									 <td><center><a href="delete_restaurant.php?res_del='.$rows['rs_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
