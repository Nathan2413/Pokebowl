                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Tous les utilisateurs</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th><center>Nom de famille</center></th>
                                                <th><center>Email</center></th>
                                                <th><center>Téléphone</center></th>
												<th><center>Addresse</center></th>												
												 <th><center>Date registre</center></th>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td><center>'.$rows['username'].'</center></td>
																								<td><center>'.$rows['f_name'].'</center></td>
																								<td><center>'.$rows['l_name'].'</center></td>
																								<td><center>'.$rows['email'].'</center></td>
																								<td><center>'.$rows['phone'].'</center></td>
																								<td><center>'.$rows['address'].'</center></td>																								
																								<td><center>'.$rows['date'].'</center></td>
																								<td><center><a href="delete_users.php?user_del='.$rows['u_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> <a href="update_users.php?user_upd='.$rows['u_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a></center></td></tr>';
																		}	
														}
											?>
                                        </tbody>
