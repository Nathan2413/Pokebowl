...
<head>
    ...
    <title>Tableau d'administrateur</title>
            ...
            <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Tableau de bord de l'administrateur</h4>
                            </div>
                     <div class="row">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Commandes totales</p>
                                </div>
                            </div>
                        </div>
                    </div>	                   
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from res_category";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Catégories de restaurant</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders WHERE status = 'in process' ";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Traitement des commandes</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                                    <span><i class="fa fa-roupie f-s-40" aria-hidden="true"><b>RS</b></i></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php 
                                        ...
                                        echo $sum;
                                        ?></h2>
                                    <p class="m-b-0">Total des gains</p>
                                </div>
                            </div>
                        </div>
                    </div>
