									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>La taille maximale de limage est de 1024 Ko !</strong> Essayez une image différente.
															</div>';
...
<head>
    ...
    <title>Mettre à jour le menu</title>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Mettre à jour le menu</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">A propos</label>
                                        ...
                                        <div class="row">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Sélectionnez un restaurant</label>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="all_menu.php" class="btn btn-inverse">Annuler</a>
                                    </div>
                                </form>
                            </div>
                        </div>
