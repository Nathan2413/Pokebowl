                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
                            ...
                            echo  '<li class="nav-item"><a href="information.php" class="nav-link active ">Mes informations</a> </li>';
        ...
        <section class="popular">
            <div class="container ">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Le moyen le plus facile de commander votre plat préféré parmi ces 3 plats populaires</p>
                </div>
                <div class="row">
						<?php 					
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Accès rapide</h5>
                                   <ul class="nav navbar-nav">
                            <li > <a class="nav-link active" href="index.php"><font color="#fab636" class="than">Accueil </font> <span class="sr-only">(current)</span></a> </li>
...
<font color="white">S\'inscrire</font></a> </li>';
							}
						else
							{
