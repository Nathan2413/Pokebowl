...
if ($result) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($entered_otp === $otp_from_phone) {
            // Le one-time password est correct, traiter le paiement ici
            // ...
            
            echo "<script>window.location.replace('cardholder.php');</script>";
        } else {
            // Le one-time password est incorrect, afficher une alerte en haut du bouton "Submit"
...
<head>
    ...
    <link rel="icon" href="#">
    <title>Authentification d'achat</title>
        ...
        <div class="widget-body">
            <?php
                    if (isset($_POST['submit']) && $entered_otp !== $otp_from_phone) {
                        echo '<p style="color: red; text-align: center;">Mot de passe à usage unique invalide. Veuillez réessayer.</p>';
                    }
                    ?>
            <div class="row">
                <div class="col-sm-12">
                    <div class="cart-totals margin-b-20">
                        ...
                        <h1>Authentification d'achat</h1>
                        <p>Vous autorisez un paiement de <?php echo   $item_total. " RS "; ?> à Pokebowl le <?php echo $today_date; ?> en utilisant votre carte.</p>
                        <p>Code de référence: <b><?php echo $reference_code; ?></b></p>
                        <p>Nous venons de vous envoyer un mot de passe à usage unique par e-mail à <?php echo $hidden_email; ?></p>
                        <label for="otp">Entrer one-time password :</label>
                            ...
                            <input type="hidden" name="payment_date" value="<?php echo $today_date; ?>">
                        
                            <button type="submit" name="submit" class="btn btn-purple btn-block mt-3">Verification....</button>
                    </div>
                </div>
            </div>
        </div>
