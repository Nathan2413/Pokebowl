...
<body>
<div style=" background-image: url('images/plats/res.jpg');">
						...
						if(empty($_SESSION["user_id"]))
							{
							  ...
							  <li class="nav-item"><a href="registration.php" class="nav-link active"><font color="#fab636" class="than">S\'nscrire </font></a> </li>';
							}
						else
							{
            ...
            <div class="container">
                ...
                <div class="bottom-footer">
                    <div class="row">
						...
						if(empty($_SESSION["user_id"]))
							{
								echo '<li><a href="login.php" class="nav-link active"><font color="white">Connexion</font></a> </li>';
                            echo  '<li ><a href="registration.php" class="nav-link active"><font color="#059e24" class="than">S\'nscrire </font></a> </li>';
							}
						else
							{
                                    ...
                                    echo  '<li ><a href="information.php?user_upd='.rows['u_id'].'" class="nav-link active "> <font color="white">A propos</font></a> </li>';
