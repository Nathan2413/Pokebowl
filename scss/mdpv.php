...
<head>
  <meta charset="UTF-8">
  <title>Code authentification</title>
...
{  
	...
	if(!empty($_POST["submit"]))   
     {
	$verifquery ="SELECT * FROM users WHERE phone='$phone1'"; 
    ...
    <form action="" method="post">
      <div class="row margin">
          <div class="input-field col s12">
            ...
            <label for="phone" class="center-align" >Code authentification</label>
          </div>
        </div>
      
        <span style="color:red;"><?php echo $message; ?></span> 
        <span style="color:green;"><?php echo $success; ?></span>
      <input type="submit" id="buttn" name="submit" value="Valider" />
    </form>
  </div>
